<x-app-layout>
    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <a href="{{ route('citizen.complaints.create') }}" class="inline-flex items-center px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                <div class="p-6 border-b border-gray-100 bg-gray-50/50 flex justify-between items-center">
                    ...
                    <a href="{{ route('citizen.complaints.index') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-800 transition-colors">View All &rarr;</a>
                </div>
                <div class="overflow-x-auto">
                                ...
                                @foreach($recentComplaints as $complaint)
                                    <tr class="hover:bg-gray-50/50 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('citizen.complaints.show', $complaint) }}" class="text-indigo-600 hover:text-indigo-900 bg-indigo-50 hover:bg-indigo-100 px-3 py-1 rounded-lg transition-colors duration-200">View</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                    ...
                    @else
                        <div class="p-12 text-center">
                            ...
                            <p class="text-gray-500 text-lg mb-4">No complaints submitted yet</p>
                            <a href="{{ route('citizen.complaints.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-colors">
                ...
                @if($recentComplaints->count() > 0)
                    <div class="p-4 border-t border-gray-100 bg-gray-50/50">
                        <div class="text-center text-sm text-gray-500">
                            Showing latest {{ $recentComplaints->count() }} complaints
                        </div>
                    </div>
                @endif
            </div>
